...
public class CeasarCipher {
    ...
    public int[] countLetters(String msg) {
        ...
        for (char c : msg.toCharArray()) {
            ...
            if (Character.isAlphabetic(cuc)) counts[alphbet.indexOf(cuc)]++;
        }
    ...
    public String encryptLetter(String ch){
        return decrypt(ch, 26 - key);
    }

    public String dencryptLetter(String ch){
